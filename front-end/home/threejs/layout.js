...
import './functionsFromLayout.js';
import '../../client-dispatcher/client-user.js';
import '../../client-dispatcher/client-misc-logic.js';
...
export const buildings = new Array();
...
const k200 = new THREE.Mesh(fun.makeGeo(Dimensions.dimXk200, Heights.hk200, Dimensions.dimZk200, Positions.posXk200, Positions.posZk200), fun.makeMaterial(0x3b5263));
fun.finishingTouches(k200, BuildingNames.namek200, 1, true);
const acco = new THREE.Mesh(fun.makeGeo(Dimensions.dimXacco, Heights.hacco, Dimensions.dimZacco, Positions.posXacco, Positions.posZacco), new THREE.MeshStandardMaterial({ map: accoTexture }));
fun.finishingTouches(acco, BuildingNames.nameacco, 1, true);
const s200 = new THREE.Mesh(fun.makeGeo(Dimensions.dimXs200, Heights.hs200, Dimensions.dimZs200, Positions.posXs200, Positions.posZs200), fun.makeMaterial(0x3b5263));
fun.finishingTouches(s200, BuildingNames.names200, 1, true);
const m200 = new THREE.Mesh(fun.makeGeo(Dimensions.dimXm200, Heights.hlm200, Dimensions.dimZm200, Positions.posXm200, Positions.posZm200), fun.makeMaterial(0x758694));
fun.finishingTouches(m200, BuildingNames.namem200, 1, true);
const l200 = new THREE.Mesh(fun.makeGeo(Dimensions.dimXl200, Heights.hlm200, Dimensions.dimZl200, Positions.posXl200, Positions.posZl200), fun.makeMaterial(0x758694));
fun.finishingTouches(l200, BuildingNames.namel200, 1, true);
const n200 = new THREE.Mesh(fun.makeGeo(Dimensions.dimXn200, Heights.hn200, Dimensions.dimZn200, Positions.posXn200, Positions.posZn200), fun.makeMaterial(0x758694));
fun.finishingTouches(n200, BuildingNames.namen200, 1, true);
const a200big = new THREE.Mesh(fun.makeGeo(Dimensions.dimXa200big, Heights.ha200, Dimensions.dimZa200big, Positions.posXa200big, Positions.posZa200big), fun.makeMaterial(0xa9aaab));
a200big.layers.set(1);
a200big.castShadow = true;
const a200n = new THREE.Mesh(fun.makeGeo(Dimensions.dimXa200n, Heights.ha200, Dimensions.dimZa200n, Positions.posXa200n, Positions.posZa200n), fun.makeMaterial(0xf52f07));
a200n.layers.set(1);
a200n.castShadow = true;
const a200s = new THREE.Mesh(fun.makeGeo(Dimensions.dimXa200s, Heights.ha200, Dimensions.dimZa200s, Positions.posXa200s, Positions.posZa200s), fun.makeMaterial(0xf52f07));
a200s.layers.set(1);
...
const c200big = new THREE.Mesh(fun.makeGeo(Dimensions.dimXc200big, Heights.hc200, Dimensions.dimZc200big, Positions.posXc200big, Positions.posZc200big), fun.makeMaterial(0xa9aaab));
c200big.layers.set(1);
c200big.castShadow = true;
const c200small = new THREE.Mesh(fun.makeGeo(Dimensions.dimXc200small, Heights.hc200, Dimensions.dimZc200small, Positions.posXc200small, Positions.posZc200small), fun.makeMaterial(0xa9aaab));
c200small.layers.set(1);
c200small.castShadow = true;
const c200med = new THREE.Mesh(fun.makeGeo(Dimensions.dimXc200med, Heights.hc200, Dimensions.dimZc200med, Positions.posXc200med, Positions.posZc200med), fun.makeMaterial(0xa9aaab));
...
const e200 = new THREE.Mesh(fun.makeGeo(Dimensions.dimXe200, Heights.he200, Dimensions.dimZe200, Positions.posXe200, Positions.posZe200), fun.makeMaterial(0xa9aaab));
...
const b200big = new THREE.Mesh(fun.makeGeo(Dimensions.dimXb200big, Heights.hb200, Dimensions.dimZb200big, Positions.posXb200big, Positions.posZb200big), fun.makeMaterial(0x3b5263));
b200big.layers.set(1);
b200big.castShadow = true;
const b200small = new THREE.Mesh(fun.makeGeo(Dimensions.dimXb200small, Heights.hb200, Dimensions.dimZb200small, Positions.posXb200small, Positions.psoZb200small), fun.makeMaterial(0x3b5263));
b200small.layers.set(1);
b200small.castShadow = true;
const b200med = new THREE.Mesh(fun.makeGeo(Dimensions.dimXb200med, Heights.hb200med, Dimensions.dimZb200med, Positions.posXb200med, Positions.posZb200med), fun.makeMaterial(0x3b5263));
...
const monibig = new THREE.Mesh(fun.makeGeo(Dimensions.dimXmonibig, Heights.hmoni, Dimensions.dimZmonibig, Positions.posXmonibig, Positions.posZmonibig), fun.makeMaterial(0xa9aaab));
...
monismallgeo.translate(Positions.posXmonismall, Heights.heightsaver + 0.15 + Heights.hmoni * 0.5, Positions.posZmonismall);
...
const f200 = new THREE.Mesh(fun.makeGeo(Dimensions.dimXf200, Heights.hf200, Dimensions.dimZf200, Positions.posXf200, Positions.posZf200), fun.makeMaterial(0xa9aaab));
fun.finishingTouches(f200, BuildingNames.namef200, 1, true);
const h200 = new THREE.Mesh(fun.makeGeo(Dimensions.dimXh200, Heights.hh200, Dimensions.dimZh200, Positions.posXh200, Positions.posZh200), fun.makeMaterial(0xa9aaab));
fun.finishingTouches(h200, BuildingNames.nameh200, 1, true);
const nanobig = new THREE.Mesh(fun.makeGeo(Dimensions.dimXnanobig, Heights.hnano, Dimensions.dimZnanobig, Positions.posXnanobig, Positions.posZnanobig), fun.makeMaterial(0x3b5263));
nanobig.layers.set(1);
nanobig.castShadow = true;
const nanosmall = new THREE.Mesh(fun.makeGeo(Dimensions.dimXnanosmall, Heights.hnano, Dimensions.dimZnanosmall, Positions.posXnanosmall, Positions.posZnanosmall), fun.makeMaterial(0x3b5263));
...
const d200long = new THREE.Mesh(fun.makeGeo(Dimensions.dimXd200long, Heights.hd200l, Dimensions.dimZd200long, Positions.posXd200long, Positions.posZd200long), fun.makeMaterial(0xc4bea5));
d200long.layers.set(1);
d200long.castShadow = true;
const d200big1 = new THREE.Mesh(fun.makeGeo(Dimensions.dimXd200big1, Heights.hd200b, Dimensions.dimZd200big1, Positions.posXd200big1, Positions.posZd200big1), fun.makeMaterial(0xa9aaab));
d200big1.layers.set(1);
d200big1.castShadow = true;
const d200big2 = new THREE.Mesh(fun.makeGeo(Dimensions.dimXd200big2, Heights.hd200b, Dimensions.dimZd200big2, Positions.posXd200big2, Positions.posZd200big2), fun.makeMaterial(0xa9aaab));
d200big2.layers.set(1);
d200big2.castShadow = true;
const d200small1 = new THREE.Mesh(fun.makeGeo(Dimensions.dimXd200small1, Heights.hd200, Dimensions.dimZd200small1, Positions.posXd200small1, Positions.posZd200small1), fun.makeMaterial(0xa9aaab));
d200small1.layers.set(1);
d200small1.castShadow = true;
const d200small2 = new THREE.Mesh(fun.makeGeo(Dimensions.dimXd200small2, Heights.hd200, Dimensions.dimZd200small2, Positions.posXd200small2, Positions.posZd200small2), fun.makeMaterial(0xa9aaab));
d200small2.layers.set(1);
d200small2.castShadow = true;
const d200small3 = new THREE.Mesh(fun.makeGeo(Dimensions.dimXd200small3, Heights.hd200, Dimensions.dimZd200small3, Positions.posXd200small3, Positions.posZd200small3), fun.makeMaterial(0xa9aaab));
d200small3.layers.set(1);
d200small3.castShadow = true;
const d200small4 = new THREE.Mesh(fun.makeGeo(Dimensions.dimXd200small4, Heights.hd200, Dimensions.dimZd200small4, Positions.posXd200small4, Positions.posZd200small4), fun.makeMaterial(0xa9aaab));
d200small4.layers.set(1);
d200small4.castShadow = true;
const d200small5 = new THREE.Mesh(fun.makeGeo(Dimensions.dimXd200small5, Heights.hd200, Dimensions.dimZd200small5, Positions.posXd200small5, Positions.posZd200small5), fun.makeMaterial(0xa9aaab));
d200small5.layers.set(1);
d200small5.castShadow = true;
const d200mini = new THREE.Mesh(fun.makeGeo(Dimensions.dimXd200mini, Heights.hd200, Dimensions.dimZd200mini, Positions.posXd200mini, Positions.posZd200mini), fun.makeMaterial(0xa9aaab));
...
const qdvlang = new THREE.Mesh(fun.makeGeo(Dimensions.dimXqdvlang, Heights.hqdv, Dimensions.dimZqdvlang, Positions.posXqdvlang, Positions.posZqdvlang), fun.makeMaterial(0x3b5263));
...
const g200b = new THREE.Mesh(fun.makeGeo(Dimensions.dimXg200b, Heights.hg200b, Dimensions.dimZg200b, Positions.posXg200b, Positions.posZg200b), fun.makeMaterial(0xa9aaab));
g200b.layers.set(1);
g200b.castShadow = true;
const g200s = new THREE.Mesh(fun.makeGeo(Dimensions.dimXg200s, Heights.hg200s, Dimensions.dimZg200s, Positions.posXg200s, Positions.posZg200s), fun.makeMaterial(0xa9aaab));
g200s.layers.set(1);
g200s.castShadow = true;
const g200m = new THREE.Mesh(fun.makeGeo(Dimensions.dimXg200m, Heights.hg200m, Dimensions.dimZg200m, Positions.posXg200m, Positions.posZg200m), fun.makeMaterial(0xa9aaab));
g200m.layers.set(1);
...
function showIntersected(object) {
    showLabel(object);
    showPopup(object);
    highlightObject(object, 0xff0000);
}
function resetIntersected(object) {
    hideLabel();
    hidePopup();
...
function highlightObject(object, hex) {
