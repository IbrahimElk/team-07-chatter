...
export class ClientChannel {
     ...
     */
    static connectChannel(client, channelId) {
     ...
     */
    static sendChannelMessage(client, textInput, GetTimeStamps, channelName, date) {
        const sessionId = client.getsessionID();
        if (sessionId) {
     ...
     */
    static disconnectChannel(client, channelCUID) {
        const sessionID = client.getsessionID();
        if (sessionID) {
     ...
     */
    static connectChannelSendback(client, document, payload) {
     ...
     */
    static channelInfo(client, document, payload) {
     ...
     */
    static disconnectChannelSendback(client, document, payload) {
        if (payload.succeeded) {
     ...
     */
    static messageSendbackChannel(document, payload) {
        if (payload.succeeded) {
...
//# sourceMappingURL=client-channel-logic.js.map