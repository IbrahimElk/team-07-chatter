...
const accoLabel = makeLabel(accoDiv, BuildingNames.nameacco, 'black');
...
const e200Div = document.createElement('div');
...
function makeLabel(element, text, color) {
...
export function showLabel(building) {
    let buildingName;
